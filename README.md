...
## ESP32 Introduction
This is a quick fun fork of the MicroQuickJS (aka. MQuickJS) Javascript engine so that it runs on Espressif ESP32 devices. Basic REPL functionality has been tested on ESP32-S3 (240Mhz dual-core Xtensa LX7), ESP32-C6 (160MHz single-core RISC-V) and ESP32-H2 (96Mhz single core RISC-V) microcontrollers.

All of the code and build configurations were generated by Cursor using a mix of ChatGPT 5.1 Codex Max and Opus 4.5. The changes are probably an abomination but it basically seems to work.

The only hardware feature support added was for WS2812 RGD LED Blinken-Lights. I will probably add basic GPIO support too.

Details on how to build and run it are in [README-ESP32.md](README-ESP32.md)
